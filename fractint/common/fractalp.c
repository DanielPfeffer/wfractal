...
struct fractalspecificstuff far fractalspecific[]=
{
   ...
   */
   ...
   t_mandel,
      ...
      0, JULIAFP, NOFRACTAL, XAXIS_NOPARM,
   ...
   t_lambda,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, MANDELLAMBDAFP, NOSYM,
   ...
   t_mandelfn,
      ...
      0, LAMBDATRIGFP, NOFRACTAL, XYAXIS_NOPARM,
      LambdaTrigfpFractal,othermandelfp_per_pixel,MandelTrigSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_manowar,
      ...
      (float)-2.5, (float)1.5, (float)-1.5, (float)1.5,
      0, MANOWARJFP, NOFRACTAL, XAXIS_NOPARM,
   ...
   t_sierpinski,
      ...
      0, NOFRACTAL, NOFRACTAL, NOSYM,
      SierpinskiFPFractal, otherjuliafp_per_pixel, SierpinskiFPSetup, StandardFractal,
      127
   },
   ...
   t_barnsleym1,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, BARNSLEYJ1FP,NOFRACTAL, XYAXIS_NOPARM,
      Barnsley1FPFractal, othermandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_barnsleyj1,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, BARNSLEYM1FP, ORIGIN,
      Barnsley1FPFractal, otherjuliafp_per_pixel, JuliafpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_barnsleym2,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, BARNSLEYJ2FP,NOFRACTAL, YAXIS_NOPARM,
      Barnsley2FPFractal, othermandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_barnsleyj2,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, BARNSLEYM2FP, ORIGIN,
      Barnsley2FPFractal, otherjuliafp_per_pixel, JuliafpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_fnplusfn,
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, NOFRACTAL, NOFRACTAL, XAXIS,
      TrigPlusTrigfpFractal, otherjuliafp_per_pixel, TrigPlusTrigfpSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_mandellambda,
      ...
      0, LAMBDAFP, NOFRACTAL, XAXIS_NOPARM,
   ...
   t_marksmandel,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, MARKSJULIAFP, NOFRACTAL, NOSYM,
      MarksLambdafpFractal, marksmandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_marksjulia,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, MARKSMANDELFP, ORIGIN,
      MarksLambdafpFractal, juliafp_per_pixel, MarksJuliafpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_mandel4,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, JULIA4FP, NOFRACTAL, XAXIS_NOPARM,
   ...
   t_barnsleym3,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, BARNSLEYJ3FP, NOFRACTAL, XAXIS_NOPARM,
      Barnsley3FPFractal, othermandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_barnsleyj3,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, BARNSLEYM3FP, NOSYM,
      Barnsley3FPFractal, otherjuliafp_per_pixel, JuliafpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_sqr_1divfn_,
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, NOFRACTAL, NOFRACTAL, NOSYM,
      Sqr1overTrigfpFractal, otherjuliafp_per_pixel, SqrTrigSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_fnzplusz,
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, NOFRACTAL, NOFRACTAL, XAXIS,
      ZXTrigPlusZfpFractal, juliafp_per_pixel, ZXTrigPlusZSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_lambdafn,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, MANDELTRIGFP, PI_SYM,
      LambdaTrigfpFractal, otherjuliafp_per_pixel, LambdaTrigSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_manfnpluszsqrd,
      ...
      (float)-2.5, (float)1.5, (float)-1.5, (float)1.5,
      0, FPJULTRIGPLUSZSQRD,   NOFRACTAL, XAXIS_NOPARM,
      TrigPlusZsquaredfpFractal, mandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_julfnpluszsqrd,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, FPMANTRIGPLUSZSQRD, NOSYM,
      TrigPlusZsquaredfpFractal, juliafp_per_pixel, JuliafnPlusZsqrdSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_manzpower,
      ...
      (float)-2.5, (float)1.5, (float)-1.5, (float)1.5,
      0, FPJULIAZPOWER, NOFRACTAL, XAXIS_NOIMAG,
      floatZpowerFractal, othermandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_julzpower,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, FPMANDELZPOWER, ORIGIN,
      floatZpowerFractal, otherjuliafp_per_pixel, JuliafpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   "manzzpwr",
      ...
      (float)-2.5, (float)1.5, (float)-1.5, (float)1.5,
      0, FPJULZTOZPLUSZPWR, NOFRACTAL, XAXIS_NOPARM,
      floatZtozPluszpwrFractal, othermandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   "julzzpwr",
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, FPMANZTOZPLUSZPWR, NOSYM,
      floatZtozPluszpwrFractal, otherjuliafp_per_pixel, JuliafpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_manfnplusexp,
      ...
      (float)-8.0, (float)8.0, (float)-6.0, (float)6.0,
      0, FPJULTRIGPLUSEXP, NOFRACTAL, XAXIS_NOPARM,
      FloatTrigPlusExponentFractal, othermandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_julfnplusexp,
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, NOFRACTAL, FPMANTRIGPLUSEXP, NOSYM,
      FloatTrigPlusExponentFractal, otherjuliafp_per_pixel, JuliafpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   "complexnewton",
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, NOFRACTAL, NOSYM,
      ComplexNewton, otherjuliafp_per_pixel, ComplexNewtonSetup, StandardFractal,
      NOBAILOUT
   },
   ...
   "complexbasin",
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, NOFRACTAL, NOSYM,
      ComplexBasin, otherjuliafp_per_pixel, ComplexNewtonSetup, StandardFractal,
      NOBAILOUT
   },
   ...
   "cmplxmarksmand",
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, COMPLEXMARKSJUL, NOFRACTAL, NOSYM,
   ...
   "cmplxmarksjul",
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, COMPLEXMARKSMAND, NOSYM,
   ...
   t_formula,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, NOFRACTAL, SETUP_SYM,
   ...
   t_spider,
      ...
      (float)-2.5, (float)1.5, (float)-1.5, (float)1.5,
      0, NOFRACTAL, NOFRACTAL, XAXIS_NOPARM,
   ...
   "tetrate",
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, NOFRACTAL, XAXIS_NOIMAG,
      TetratefpFractal, othermandelfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   "magnet1m",
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, MAGNET1J, NOFRACTAL, XAXIS_NOPARM,
   ...
   "magnet1j",
      ...
      (float)-8.0, (float)8.0, (float)-6.0, (float)6.0,
      0, NOFRACTAL, MAGNET1M, XAXIS_NOIMAG,
   ...
   "magnet2m",
      ...
      0, MAGNET2J, NOFRACTAL, XAXIS_NOPARM,
   ...
   "magnet2j",
      ...
      (float)-8.0, (float)8.0, (float)-6.0, (float)6.0,
      0, NOFRACTAL, MAGNET2M, XAXIS_NOIMAG,
   ...
   t_fn_z_plusfn_pix_,
      ...
      0, NOFRACTAL, NOFRACTAL, NOSYM,
      Richard8fpFractal, otherrichard8fp_per_pixel, MandelfpSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_marksmandelpwr,
      ...
      (float)-2.5, (float)1.5, (float)-1.5, (float)1.5,
      0, NOFRACTAL, NOFRACTAL, XAXIS_NOPARM,
      MarksMandelPwrfpFractal, marks_mandelpwrfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_tims_error,
      ...
      0, NOFRACTAL, NOFRACTAL, XAXIS_NOPARM,
      TimsErrorfpFractal, marks_mandelpwrfp_per_pixel, MandelfpSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_lambda_fnorfn_,
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, NOFRACTAL, FPMANLAMFNFN, ORIGIN,
      LambdaTrigOrTrigfpFractal, otherjuliafp_per_pixel, LambdaTrigOrTrigSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_julia_fnorfn_,
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, NOFRACTAL, FPMANFNFN, XAXIS,
      JuliaTrigOrTrigfpFractal, otherjuliafp_per_pixel, JuliaTrigOrTrigSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_manlam_fnorfn_,
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, FPLAMBDAFNFN, NOFRACTAL, XAXIS_NOPARM,
      LambdaTrigOrTrigfpFractal, othermandelfp_per_pixel, ManlamTrigOrTrigSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_mandel_fnorfn_,
      ...
      (float)-4.0, (float)4.0, (float)-3.0, (float)3.0,
      0, FPJULFNFN, NOFRACTAL, XAXIS_NOPARM,
      JuliaTrigOrTrigfpFractal, othermandelfp_per_pixel, MandelTrigOrTrigSetup, StandardFractal,
      LTRIGBAILOUT
   },
   ...
   t_phoenix,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, MANDPHOENIXFP, XAXIS,
   ...
   t_mandphoenix,
      ...
      (float)-2.5, (float)1.5, (float)-1.5, (float)1.5,
      0, PHOENIXFP, NOFRACTAL, NOSYM,
      PhoenixFractal, mandphoenix_per_pixel, MandPhoenixSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   "hypercomplex",
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, HYPERCMPLXJFP, NOFRACTAL, XAXIS,
   ...
   "hypercomplexj",
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, HYPERCMPLXFP, ORIGIN,
   ...
   t_phoenixcplx,
      ...
      (float)-2.0, (float)2.0, (float)-1.5, (float)1.5,
      0, NOFRACTAL, MANDPHOENIXFPCPLX, ORIGIN,
      PhoenixFractalcplx, phoenix_per_pixel, PhoenixCplxSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   t_mandphoenixcplx,
      ...
      (float)-2.5, (float)1.5, (float)-1.5, (float)1.5,
      0, PHOENIXFPCPLX, NOFRACTAL, XAXIS,
      PhoenixFractalcplx, mandphoenix_per_pixel, MandPhoenixCplxSetup, StandardFractal,
      STDBAILOUT
   },
   ...
   "escher_julia",
      ...
      0, NOFRACTAL, NOFRACTAL, ORIGIN,
      EscherfpFractal, juliafp_per_pixel, StandardSetup, StandardFractal,
      STDBAILOUT
   },
